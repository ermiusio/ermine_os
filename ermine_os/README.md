...
Процесс сборка и струтура дистрибутива вмете стеситровнием и скриншотмаи подробно разобраны в статье в моём репозитории по ссылке [overview_private_os](https://github.com/ermiusio/overview_private_os), но кратко расскажу, как её установить.
